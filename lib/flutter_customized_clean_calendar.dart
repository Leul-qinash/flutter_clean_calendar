library flutter_customized_clean_calendar;
...
class Calendar extends StatefulWidget {
  ...
  final List<dynamic>? toolTips;
  dynamic activeTooltip;
    ...
    return Container(
      child: SimpleGestureDetector(
        ...
        child: Column(children: <Widget>[
          GridView.count(
            key: ValueKey(widget.activeTooltip),
    ...
    calendarDays.forEach(
      (day) {
        ...
        if (this.widget.dayBuilder != null) {
          ...
          bool isAdded = false;
          widget.toolTips!.forEach((element) {
            DateTime toolTipDay =
                DateTime.fromMillisecondsSinceEpoch(element.date);
            if (DateTime(toolTipDay.year, toolTipDay.month, toolTipDay.day) ==
              ...
              dayWidgets.add(
                CalendarTile(
                  ...
                  tooltipColor: Colors.orange[700],
                  selectedColor: widget.selectedColor,
                  todayColor: widget.todayColor,
                  eventColor: widget.eventColor,
                  eventDoneColor: widget.eventDoneColor,
